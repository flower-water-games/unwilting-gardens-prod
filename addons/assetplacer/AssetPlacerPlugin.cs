...
public partial class AssetPlacerPlugin : ContextlessPlugin
{
	...
	public static string godotVersion = "4.1";
	...
	private void UiToExternalWindow()
	{
		...
		w.Position =  (Vector2I) GetEditorInterface().GetBaseControl().GetViewportRect().GetCenter() - w.Size/2;
	}
	...
	private void ProcessRotatingInstance()
	{
		...
		if (!lmbPressed)
		{
			...
			undo.CreateAction($"Place {_assetPalette.SelectedAssetName} asset", UndoRedo.MergeMode.Disable, _spawnParentSelection.SpawnParent);
	...
	private void ProcessPaintingHologram()
	{
		...
		if (!lmbPressed)
		{
			...
			undo.CreateAction(actionName, UndoRedo.MergeMode.Disable, _spawnParentSelection.SpawnParent);
